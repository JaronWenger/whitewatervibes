...
const BASE_URL = import.meta.env.DEV ? '' : '/whitewatervibes';
...
Promise.all([
    ...
    const waterNormals = new THREE.TextureLoader().load(`${BASE_URL}/textures/waternormals.jpg`, 
        function(texture) {
